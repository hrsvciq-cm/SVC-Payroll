...
export function calculatePayrollForEmployee(employee, attendance, deductions, month) {
  ...
  // الراتب الأساسي يبقى ثابت (من بيانات الموظف)
  // Base salary remains constant (from employee data)
  const baseSalary = employee.salary
  
  // Calculate daily salary - الراتب اليومي = الراتب الأساسي ÷ أيام العمل (30)
  const dailySalary = baseSalary / STANDARD_MONTH_DAYS
