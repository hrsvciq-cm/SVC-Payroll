...
export const prisma =
  ...
  new PrismaClient({
    ...
    // CRITICAL: Connection pool settings are handled by DATABASE_URL connection string
    // Supabase connection string already includes pooler settings (?pgbc for connection pooling)
  })
